...
WebUI.click(findTestObject('Object Repository/Cura/Page_CURA Healthcare Service/span_Visit Date (Required)_glyphicon glyphi_cada34'))

WebUI.click(findTestObject('Object Repository/Cura/Page_CURA Healthcare Service/td_20'))
